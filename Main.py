...
def create_contract():
    ...
    def save_contract():
        ...
        try:
            ...
            #delivery_time = datetime.strptime(delivery_time, "%D:%H").time()
            weight = float(weight)
            date = int(date)
    ...
    t_lb = Label(contract_window, text="(D:H)",font=("Cooper Black", 10))
    t_lb.pack()
...
def client_reg():
    ...
    client_reg_window.geometry("400x250")
    center_window(client_reg_window)

    firm_lab = tk.Label(client_reg_window, text="Firm name:",font=("Cooper Black", 11))
    firm_lab.pack()
    firm_lab.place(x=10, y=25)

    firm_ent = tk.Entry(client_reg_window)
    firm_ent.pack()
    firm_ent.place(x=150, y=28)

    address_lab = tk.Label(client_reg_window, text="Address:",font=("Cooper Black", 11))
    address_lab.pack()
    address_lab.place(x=10, y=65)

    address_ent = tk.Entry(client_reg_window)
    address_ent.pack()
    address_ent.place(x=150, y=68)

    phone_lab = tk.Label(client_reg_window, text="Phone number:",font=("Cooper Black", 11))
    phone_lab.pack()
    phone_lab.place(x=10, y=105)

    phone_ent = tk.Entry(client_reg_window)
    phone_ent.pack()
    phone_ent.place(x=150, y=108)

    pib_label = tk.Label(client_reg_window, text="PIB:",font=("Cooper Black", 11))
    pib_label.pack()
    ...
    sv_btn = tk.Button(client_reg_window, text="Write to file",
...
def dispatcher_reg():
    ...
    firm_label = tk.Label(dispatcher_reg_window, text="Firm name:",font=("Cooper Black", 11))
    firm_label.pack()
    firm_label.place(x=10, y=25)

    firm_entry = tk.Entry(dispatcher_reg_window)
    firm_entry.pack()
    firm_entry.place(x=150, y=28)

    address_label = tk.Label(dispatcher_reg_window, text="Address:",font=("Cooper Black", 11))
    address_label.pack()
    ...
    phone_label = tk.Label(dispatcher_reg_window, text="Phone number:",font=("Cooper Black", 11))
    phone_label.pack()
    phone_label.place(x=10, y=105)

    phone_entry = tk.Entry(dispatcher_reg_window)
    phone_entry.pack()
    phone_entry.place(x=150, y=108)

    pib_label = tk.Label(dispatcher_reg_window, text="PIB:",font=("Cooper Black", 11))
    pib_label.pack()
    pib_label.place(x=10, y=145)
    ...
    experience_label = tk.Label(dispatcher_reg_window, text="Work experience:",font=("Cooper Black", 11))
    ...
    save_btn = tk.Button(dispatcher_reg_window, text="Write to file",
